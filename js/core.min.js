...
/**
 * @module       Materianize Parallax banner
...
!function(o){o.fn.UItoTop2=function(n){var e={text:"",min:500,scrollSpeed:800,containerID:"ui-to-top2",containerClass:"ui-to-top2 fa fa-whatsapp",easingType:"easeIn"},t=o.extend(e,n),i="#"+t.containerID;o("body").append('<a href="https://api.whatsapp.com/send?phone=593991713039&text=Hola%21%20he%20visitado%20su%20sitio%20web%20y%20quisiera%20m%C3%A1s%20informaci%C3%B3n%20%20acerca%20de%20sus%20servicios." target="_blank" id="'+t.containerID+'" class="'+t.containerClass+'" >'+t.text+"</a>")}}(jQuery);
